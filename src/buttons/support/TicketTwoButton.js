...
class TicketTwoButton extends SimpleTicketButton {
    constructor() {
        super('ticketTwoButton');
    }
    ...
    async run(client, interaction) {
        ...
        await DatabaseHelper.updateRatingModerator({ guildId, userId: dataTicket.agentId, number: 2 });
        ...
        member.cache.two_rep += 1;

        const helper = new TicketService(client);
        let ratingEmbed = helper._buildEmbed('Blue', 'Evaluation', false, 
        `${ticketMember}, You rated the support agent's performance at 2 out of 5 points`,
...
module.exports = TicketTwoButton;