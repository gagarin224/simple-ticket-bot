...
class TicketOneButton extends SimpleTicketButton {
    constructor() {
        super('ticketOneButton');
    }
    ...
    async run(client, interaction) {
        ...
        await DatabaseHelper.updateRatingModerator({ guildId, userId: dataTicket.agentId, number: 1 });
        ...
        member.cache.one_rep += 1;

        const helper = new TicketService(client);
        let ratingEmbed = helper._buildEmbed('Blue', 'Evaluation', false, 
        `${ticketMember}, You rated the support agent's performance at 1 out of 5 points`,
...
module.exports = TicketOneButton;