...
class TicketFiveButton extends SimpleTicketButton {
    constructor() {
        super('ticketFiveButton');
    }
    ...
    async run(client, interaction) {
        ...
        await DatabaseHelper.updateRatingModerator({ guildId, userId: dataTicket.agentId, number: 5 });
        ...
        member.cache.five_rep += 1;

        const helper = new TicketService(client);
        let ratingEmbed = helper._buildEmbed('Blue', 'Evaluation', false, 
        `${ticketMember}, You rated the support agent's performance at 5 out of 5 points`,
...
module.exports = TicketFiveButton;