...
class TicketThreeButton extends SimpleTicketButton {
    constructor() {
        super('ticketThreeButton');
    }
    ...
    async run(client, interaction) {
        ...
        await DatabaseHelper.updateRatingModerator({ guildId, userId: dataTicket.agentId, number: 3 });
        ...
        member.cache.three_rep += 1;

        const helper = new TicketService(client);
        let ratingEmbed = helper._buildEmbed('Blue', 'Evaluation', false, 
        `${ticketMember}, You rated the support agent's performance at 3 out of 5 points`,
...
module.exports = TicketThreeButton;